Pod::Spec.new do |s|
	...
	s.subspec 'Default' do |ds|
		...
		ds.source_files = 'Classes/*.{h,m}'
	
		ds.subspec 'GCD' do |ss|
			ss.source_files = 'Classes/GCD/*.{h,m}'
		end

		ds.subspec 'OperationQueue' do |ss|
			ss.source_files = 'Classes/OperationQueue/*.{h,m}'
		end

		ds.subspec 'Operations' do |ss|
			ss.source_files = 'Classes/Operations/*.{h,m}'
		end

		ds.subspec 'Results' do |ss|
			ss.source_files = 'Classes/Results/*.{h,m}'
		end

		ds.subspec 'Utils' do |ss|
